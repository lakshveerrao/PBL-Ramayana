...
export const MOTION_ENDPOINTS = {
  ...
  // MY ERROR, corrected 2026-09-23: this was recorded as "404 - no such endpoint" and
  // Seedance was written off. The path was wrong - it is under bytedance/, the same as
  // the seedream image endpoints two tables up, which I had already typed correctly.
  // A 404 says the path is wrong, never that the model does not exist.
  'fal-ai/seedance/v1/pro/image-to-video':            { exists: false, usd: null, seconds: null, estimated: true, family: 'seedance', note: '404 - WRONG PATH, not a missing model. See bytedance/seedance below.' },
  'fal-ai/bytedance/seedance/v1/pro/image-to-video':  { exists: true, usd: 0.62, seconds: 5, estimated: true, family: 'seedance', note: 'probed 2026-09-23; takes prompt + image_url like the rest' },
  'fal-ai/bytedance/seedance/v1.5/pro/image-to-video': { exists: true, usd: 0.70, seconds: 5, estimated: true, family: 'seedance', note: 'newer; same request shape' },
  'fal-ai/bytedance/seedance/v1/lite/image-to-video': { exists: true, usd: 0.18, seconds: 5, estimated: true, family: 'seedance', note: 'the cheap tier' },
};
